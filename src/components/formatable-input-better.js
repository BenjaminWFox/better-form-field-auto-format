...
const handleOnChange = (e) => {
  // e.target.selectionStart returns the users cursor position within the input string
  // if it is not at the end, we can assume they are editing something, and skip formatting
  if (e.target.selectionStart === e.target.value.toString().length) {
    e.target.value = onInputValueChange(e.target.value)
  }
